...
class INET_API Ieee802154UwbIrTransmitter : public TransmitterBase
{
  ...
  protected:
    ...
    virtual void generateSyncPreamble(std::map<simtime_t, W>& data, simtime_t& time, const simtime_t startTime) const;
    virtual void generateSFD(std::map<simtime_t, W>& data, simtime_t& time, const simtime_t startTime) const;
    virtual void generatePhyHeader(std::map<simtime_t, W>& data, simtime_t& time, const simtime_t startTime) const;
    virtual void generateBurst(std::map<simtime_t, W>& data, simtime_t& time, const simtime_t startTime, const simtime_t burstStart, short polarity) const;
    virtual void generatePulse(std::map<simtime_t, W>& data, simtime_t& time, const simtime_t startTime, short polarity, double peak, const simtime_t chip) const;
