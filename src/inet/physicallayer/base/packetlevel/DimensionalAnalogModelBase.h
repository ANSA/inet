...
class INET_API DimensionalAnalogModelBase : public AnalogModelBase
{
  ...
  public:
    virtual const Ptr<const math::IFunction<WpHz, math::Domain<simtime_t, Hz>>> computeReceptionPower(const IRadio *radio, const ITransmission *transmission, const IArrival *arrival) const;
